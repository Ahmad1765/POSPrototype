...
interface AppState {
  ...
  addContact: (contact: Omit<BeneficiaryContact, 'id'>) => void;
  ...
  // Modal Navigation
  activeModal: 'QR_SCANNER' | 'PAYMENT' | 'TOP_UP' | 'MANAGE_CARD' | 'REWARDS' | 'SEARCH' | 'NOTIFICATIONS' | 'RECEIPT' | 'SPLIT_BILL' | 'ADD_CONTACT' | null;
